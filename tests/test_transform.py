...
class TransformTests(unittest.TestCase):
    ...
    @patch("transform.Transform.id_maker", return_value=unittest.mock)
    @patch("transform.Transform.get_id", return_value=unittest.mock)
    def test_transform(self, mock_location_id, mock_id_maker, mock_pay_method, mock_drink_breaker, mock_person_breaker, mock_date_breaker):
    ...
    def basket_generator(self):
        mock_trans_id = "1"
        mock_drink_id_list = "2"
        expected_outcome = {"1": "2"}
        actual_outcome = self.app.basket_generator(mock_trans_id, mock_drink_id_list)
        self.assertEqual(expected_outcome, actual_outcome)
