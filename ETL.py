...
# if filename=="*.csv" --> raw_data_list = app.get_data_from_bucket(filename)
#     csv=True  
# else
# raw_data = app.load_a_min() # change select query to ignore id column (fixing wrong column issue)
